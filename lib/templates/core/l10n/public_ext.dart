class l10nPublicExtensionsGenerator {
  /// Generates the code for the public extensions.
  static String gen() {
    return '''
...
import 'app_localization_app.dart';
...
extension BuildContextEasyLocalizationExtension on BuildContext {
  ...
  Future<void> setLocale(Locale val) async =>
      AppLocalizations.of(this)!.setLocale(val);
  ...
  set locale(Locale val) => AppLocalizations.of(this)!.setLocale(val);

  /// Get List of supported locales.
  List<Locale> get supportedLocales =>
      AppLocalizations.of(this)!.supportedLocales;

  /// Get fallback locale
  Locale? get fallbackLocale => AppLocalizations.of(this)!.fallbackLocale;
  ...
  List<LocalizationsDelegate> get localizationDelegates =>
      AppLocalizations.of(this)!.delegates;

  /// Clears a saved locale from device storage
  Future<void> deleteSaveLocale() =>
      AppLocalizations.of(this)!.deleteSaveLocale();

  /// Getting device locale from platform
  Locale get deviceLocale => AppLocalizations.of(this)!.deviceLocale;
  Locale? get savedLocale => AppLocalizations.of(this)!.savedLocale;

  /// Reset locale to platform locale
  Future<void> resetLocale() => AppLocalizations.of(this)!.resetLocale();
