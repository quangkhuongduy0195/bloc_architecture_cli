...
class FeatureCommand {
  Future<void> execute(ArgResults results) async {
    ...
    if (featureName == null) {
      print(
          'Please provide a feature name: flutter_gen feature <feature_name>');
      return;
    }
    ...
    if (!pubspecFile.existsSync()) {
      print(
          'Error: Not in a Flutter project directory. Please run this command from the root of your Flutter project.');
      return;
    }
